...
public interface Commands {
    ...
    static void printCommands() {
        ...
        System.out.println("please input " + PRINT_ALL_PATIENTS_BY_DOCTOR + " print all  patients by doctor");
        System.out.println("please input " + PRINT_TODAYS_PATIENTS + " print todays patients");
    }
}